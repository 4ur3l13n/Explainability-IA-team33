...
| Model used to justify termination | System is scoped to retention support only — this is documented and surfaced in the UI |
...
| GPU required   | No                                    |
| Estimated CO₂ | Negligible — CPU only, small dataset |
